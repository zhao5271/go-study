...
### F. 代码示例（最小可运行）
文件：`/Users/zhang/Desktop/go-study/codex/go-learning/cmd/day03/02_interfaces_embedding/main.go`
```go
package main
...
### G. 怎么运行（命令 + 预期现象）
```bash
go run ./cmd/day03/02_interfaces_embedding
...
### I. 参考答案（紧跟练习题）
参考答案 1（可运行）：
- 文件：`/Users/zhang/Desktop/go-study/codex/go-learning/cmd/day03/02_interfaces_embedding_ex1/main.go`
- 运行：
```bash
go run ./cmd/day03/02_interfaces_embedding_ex1
...
### F. 代码示例（最小可运行）
文件：`/Users/zhang/Desktop/go-study/codex/go-learning/cmd/day03/02_interfaces_embedding_ex2/main.go`

### G. 怎么运行（命令 + 预期现象）
```bash
go run ./cmd/day03/02_interfaces_embedding_ex2
